     ...
     <form id="form1" runat="server">
        <div class="centrado-porcentual">
            ...
            <asp:Button ID="BtnUpFile" runat="server" Text="CARGAR  DOCUMENTO" Width="428px" OnClick="BtnUpFile_Click" Height="35px" BackColor="#999999" /><br /><br />
             ...
             <asp:DropDownList ID="ddlMensaje" runat="server" Height="22px" Width="418px" BackColor="#CCCCCC"></asp:DropDownList><br />
             ...
             <asp:Button ID="btnFirmarEnviarDocumento" runat="server" Text="FIRMAR Y ENVIAR DOCUMENTO" Width="428px"  Height="35px" BackColor="#999999" OnClick="btnFirmarEnviarDocumento_Click" /><br /><br />
